...
class Tarea1 {//Se declara la clase Tarea1
    ...
    public static void main(String[] args) {//Método main
        ...
        System.out.println(sumar(a, b));//Se manda a llamar la función
    }//Llave que cierra el main

    public static int sumar(int x, int y) {//Se crea la función sumar
