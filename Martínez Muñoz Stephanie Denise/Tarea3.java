...
class Tarea3 {//Se declara la clase Tarea3
    ...
    public static void main(String[] args) {//Método main
        ...
        System.out.println(multiplicar(a, b));//Se manda a llamar la función
    }//Llave que cierra el main

    public static int multiplicar(int x, int y) {//Se crea la función multiplicar
