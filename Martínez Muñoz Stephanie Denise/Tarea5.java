...
class Tarea5 {//Se declara la clase Tarea5
    ...
    public static void main(String[] args) {//Método main
        ...
        System.out.println(residuo(a, b));//Se manda a llamar la función
    }//Llave que cierra el main

    public static int residuo(int x, int y) {//Se crea la función residuo
